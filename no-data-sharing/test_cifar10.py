...
def load_data():
    ...
    for i in range(10):
        client_indices = indices[i * 5000:(i + 1) * 5000]
...
# ----- Main Loop -----
def federated_learning(model_type, rounds):
    ...
    filename = f"cifar10_{model_type}.csv"
...
if __name__ == "__main__":
    ...
    federated_learning(args.model,args.rounds)
